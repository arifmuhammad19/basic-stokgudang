<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <div class="fa fa-cart-plus"></div> Barang Keluar
  ...
  <section class="content">
    ...
    <!-- Button Cetak Barang Keluar Modal -->
  ...
  ?>
    <tr>
      ...
      <td><?php echo $klr->nama_barang; // Displaying the name ?></td>
      <td><?php echo tgl_indo($klr->tanggal); ?></td>
      <td><?php echo $klr->tujuan ?></td>
...
<div class="modal fade" id="editKeluar<?php echo $klr->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><div class="fa fa-calendar"></div> Edit Barang Keluar</h4>
      </div>
      <form action="<?php echo base_url('admin/keluar/edit') ?>" method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Tujuan</label>
            <input type="text" name="tujuan" class="form-control" value="<?php echo $klr->tujuan ?>" placeholder="Tujuan" required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="reset" class="btn btn-danger"><div class="fa fa-trash"></div> Reset</button>
